...
@DatabaseMetaPlugin( type = "neo4j", typeDescription = "Neo4j" )
public class Neo4jDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
  ...
  public String getDriverClass() {
    return "org.pentaho.di.plugins.database.Neo4jProxyDriver";

  }

  @Override
  public String getURL( String hostname, String port, String databaseName ) {
    return "jdbc:neo4j://" + hostname + ":" + port + "/" + databaseName;
